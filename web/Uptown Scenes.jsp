...
<section class="main">
    <%-- Img tag is used to import image --%>
             <center><h1>Uptown Scenes</h1><center>
             <hr>
        <input type="submit" value="Join" id="join_group_button" onClick="Join('Uptown Scenes')">
        <br>
...
<section class="login_form">
    ...
    <input type="hidden" value="Uptown Scenes" name="group_name">
...
<section class="main">
    <div id="main">
        ...
        }else
        {
            ...
            int post_id = 0;
            String query1="select p.post as post_text, p.post_id as post_id, u.u_name as uname from posts p, users u, post_user_group_relationship pug, groups g where p.post_id = pug.p_id and pug.u_id = u.u_id and pug.g_id = g.g_id and g.g_name = 'Uptown Scenes'";
